            ...
            <div className="collapse navbar-collapse" id="navbarCollapse">
              ...
              <ul className="navbar-nav">
                <li className="nav-item">
                  <a className="nav-link" asp-controller="Home" asp-action="Index">
                    {" "}
                    <i className=" fa-solid fa-house"></i> Home{" "}
                  </a>
                </li>
                <li className="nav-item">
                  <a className="nav-link" asp-controller="Home" asp-action="About">
                    {" "}
                    <i className="fa-solid fa-briefcase"></i> Sobre nós{" "}
                  </a>
                </li>
                <li className="nav-item">
                  <a className="nav-link" asp-controller="Home" asp-action="Rights">
                    {" "}
                    <i className="fa-solid fa-book-open-reader"></i> Seus Direitos{" "}
                  </a>
                </li>
